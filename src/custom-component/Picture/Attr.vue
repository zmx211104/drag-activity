...
<!-- 		<el-form>
			<el-form-item label="图片宽度">
				<el-input  v-model.number="curComponent.propValue.width" type="number" />
			</el-form-item>
			<el-form-item label="图片高度">
				<el-input  v-model.number="curComponent.propValue.height" type="number" />
			</el-form-item>
		</el-form> -->
		<el-form>
		    <el-form-item label="图片">
				<div class="material">
					<div class="material-body" v-if="curComponent.propValue.imgSrc">
					  <el-row class="material-row">
						<el-col>
						  <div class="material" style="margin-left:60px">
							<img class="material-image" :src="curComponent.propValue.imgSrc">
							<div class="material-replace" @click="openMaterialDialog('')">替换</div>
						  </div>
						</el-col>
					  </el-row>
					</div>
		...
		<el-form>
			<el-form-item label="前置条件" prop="beforeKey" style="width:30%;margin-left:10px">
				 <div>
					 <el-select placeholder="前置条件" v-model="curComponent.propValue.beforeKey" style="width:200px" @change="handleChange">
						<el-option
						   v-for="option in beforeBiz"
						   :key="option.key"
						   :label="option.value"
						   :value="option.key"
						 ></el-option>
		...
		<!-- 选择素材 -->
		   <el-dialog title="选择素材" :visible.sync="materialDialogg" width="980px">
		     <el-form ref="refForm" label-width="120px">
		       ...
		       <div class="yu-grpButton">
		         ...
		         <el-button icon="yx-undo2" type="primary" @click="materialDialogg = false">取消</el-button>
		       </div>
		     </el-form>
		   </el-dialog>
   <!--     <el-form>
	...
	methods: {
		 // 替换按钮-打开素材弹窗
		      ...
		      upadateMateria: function () {
		        ...
		        let that = this;
		      //更新画布中的图片
				this.curComponent.propValue.imgSrc = this.selectMaImgSrc;
				this.curComponent.propValue.url = this.selectMaImgSrc;
		        this.materialDialogg = false;
		      },
			  handleChange(e){
				  console.log("e===",e)
